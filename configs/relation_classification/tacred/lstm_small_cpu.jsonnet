function (
  ...
  word_dropout = 0.04,
  embedding_dim = 50, embedding_trainable = false, embedding_dropout = 0.0,
  ner_embedding_dim = null, pos_embedding_dim = null, dep_embedding_dim = null,
  offset_type = "relative", offset_embedding_dim = 15,
  text_encoder_hidden_dim = 50, text_encoder_num_layers = 1, text_encoder_bidirectional = false,
